...
export function Projects() {
  return (
    ...
    >
      <div
        className="relative max-w-4xl mx-auto p-8 pt-16 bg-white/90 backdrop-blur-md shadow-lg border border-white/60 text-center"
